...
//    #region 新版
//    public delegate bool StateTrans(bool isTrue, params object[] obj);

//    private Dictionary<TriggerAction, StateTrans> dic_state_trans = new Dictionary<TriggerAction, StateTrans>();

//    private void _InitDicTrans()
//    {
//        dic_state_trans = new Dictionary<TriggerAction, StateTrans>()
//        {
//             {TriggerAction.Attack,_GetKey},
//            //{ TriggerAction.}

//        };
//    }

//    private bool _GetKey(bool isTrue, params object[] obj)
//    {
//        if (obj.Length != 1)
//            return false;
//        KeyCode key = (KeyCode)obj[0];
//        return Input.GetKey(key) && isTrue;
//    }
...
//                mFeeders[i].Feed(size, offset, collider.type, data.damage, data.strength, data.force, false, remainTime, mQFSMLite.CurState);
//                mFeeders[i + mPhyBoxCount].Feed(size, offset, collider.type, data.damage, data.strength, data.force, true, remainTime, mQFSMLite.CurState);
//            }
//            else if (collider.type != HitboxType.TRIGGER)
//            {
//                int j = i > mPhyBoxCount * 2 - 1 ? i : i += mPhyBoxCount + 1;
//                mFeeders[j].Feed(size, offset, collider.type, data.damage, data.strength, data.force, true, remainTime, mQFSMLite.CurState);
//            }
...
//        DUNFU = (KeyCode)System.Enum.Parse(typeof(KeyCode), mInpuSetting[9].Key);
//        mSetSqlite.Close();
//    }
...
//                if (mSpriteRenderer != null && mSpriteRenderer.flipX)
//                {
//                    rect.x *= -1;
//                    rect.width *= -1;
//                }
...
public class CharacterFSM : ACTFSM
{
    [Header("Keyboard keys")]
    public KeyCode UP;
    public KeyCode DOWN;
